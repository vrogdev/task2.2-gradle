...
/**
 * Precompiled multi.project.java-application-conventions script plugin.
 **/
public class MultiProjectJavaApplicationConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_MultiProjectJavaApplicationConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("multi.project.java-common-conventions");
            target.getPluginManager().apply("application");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_MultiProjectJavaApplicationConventions").asSubclass(BasicScript.class);
